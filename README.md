...
<p align="center">
  <img src="https://telegra.ph/file/dce1d824b4258874f6db6.jpg" /></>
</p>
...
project/
├── app.js                <-- File utama backend Node.js
├── package.json          <-- Konfigurasi Node.js
├── public/               <-- Folder untuk file statis (CSS, gambar, dll.)
│   └── style.css         <-- File CSS untuk tampilan
├── views/                <-- Folder untuk file template HTML (EJS)
│   ├── index.ejs         <-- Halaman utama
│   ├── upload.ejs        <-- Halaman upload file
│   ├── download.ejs      <-- Halaman download setelah verifikasi
